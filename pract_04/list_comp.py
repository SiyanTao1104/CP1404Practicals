...
lowercase_full_case = [name.lower() for name in full_names]
print(lowercase_full_case)
...
greater_numbers = [int(almost_numbers) for almost_numbers in almost_numbers if int(almost_numbers) > 9]
